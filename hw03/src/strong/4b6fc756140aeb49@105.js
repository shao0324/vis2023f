...
Inputs.color({ label: "background color", value: "#F0F0F0" })
)}

function _strokeColor(Inputs){return(
Inputs.color({ label: "stroke color", value: "#642100" })
)}
...
{
  const color = d3.scaleQuantize([0, LivePlace_uniqueValues.length + 10], d3.schemeGnBu[9]);
